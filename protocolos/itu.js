...
const s1 = [
  ...
  bp('A este escenario microbiológico se suma el contexto fisiopatológico de la altitud de Quito (2.850 m.s.n.m.), donde la hipoxia hipobárica crónica puede enmascarar o potenciar manifestaciones de la ITU complicada —taquipnea, taquicardia y alteración del estado de conciencia— dificultando el reconocimiento precoz de la urosepsis. Los valores de referencia deben ajustarse: la SatO₂ basal es de 88–92 % y la PaO₂ basal de 65–70 mmHg —cifras de población andina sana estudiada a 2.640 m, extrapoladas a los 2.850 m de Quito y que descienden con la edad, más en mujeres—, y el umbral de fiebre se sitúa en T > 37,5 °C axilar. La hipoxia crónica influye además en la masa muscular y en la estimación de la función renal, lo que condiciona el ajuste de dosis de antimicrobianos nefrotóxicos[[8]].'),
